...
require_once("include/List_ConvocatoriasNacionales_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "List_ConvocatoriasNacionales" );
