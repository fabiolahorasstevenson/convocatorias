...
require_once("include/ConvocatoriasNacionales_PrintPDF_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "ConvocatoriasNacionales_PrintPDF" );
