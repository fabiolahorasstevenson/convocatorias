...
require_once("include/List_ConvocatoriasProvinciales_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "List_ConvocatoriasProvinciales" );
