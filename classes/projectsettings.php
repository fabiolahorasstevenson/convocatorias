...
class ProjectSettings
{
	...
	*/
	...
	function getConnId()
	{
		...
		if( $connId == "" ) {
			return "Mesa_Entrada_at_10_20_96_220";
		}
		return $connId;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "I_ConvocatoriasNacionales" ] = array( "url" => "I_ConvocatoriasNacionales", "type" => 0 );
	$projectEntitiesReverse[ "I_ConvocatoriasNacionales" ] = "I_ConvocatoriasNacionales";
	$projectEntities[ "List_ConvocatoriasNacionales" ] = array( "url" => "List_ConvocatoriasNacionales", "type" => 1 );
	$projectEntitiesReverse[ "List_ConvocatoriasNacionales" ] = "List_ConvocatoriasNacionales";
	$projectEntities[ "I_ConvNacMailsNotif" ] = array( "url" => "I_ConvNacMailsNotif", "type" => 0 );
	$projectEntitiesReverse[ "I_ConvNacMailsNotif" ] = "I_ConvNacMailsNotif";
	$projectEntities[ "Mails para notificar" ] = array( "url" => "Mails_para_notificar", "type" => 1 );
	$projectEntitiesReverse[ "Mails_para_notificar" ] = "Mails para notificar";
	$projectEntities[ "ConvocatoriasNacionales_PrintPDF" ] = array( "url" => "ConvocatoriasNacionales_PrintPDF", "type" => 1 );
	$projectEntitiesReverse[ "ConvocatoriasNacionales_PrintPDF" ] = "ConvocatoriasNacionales_PrintPDF";
	$projectEntities[ "I_ConvocatoriasProvinciales" ] = array( "url" => "I_ConvocatoriasProvinciales", "type" => 0 );
	$projectEntitiesReverse[ "I_ConvocatoriasProvinciales" ] = "I_ConvocatoriasProvinciales";
	$projectEntities[ "List_ConvocatoriasProvinciales" ] = array( "url" => "List_ConvocatoriasProvinciales", "type" => 1 );
	$projectEntitiesReverse[ "List_ConvocatoriasProvinciales" ] = "List_ConvocatoriasProvinciales";
}
