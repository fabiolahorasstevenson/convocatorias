...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("I_ConvocatoriasNacionales" == $this->chrt_array['tables'][0])
			return true;
		if("I_ConvocatoriasNacionales" == $this->chrt_array['tables'][0])
			return true;
		if("I_ConvNacMailsNotif" == $this->chrt_array['tables'][0])
			return true;
		if("I_ConvNacMailsNotif" == $this->chrt_array['tables'][0])
			return true;
		if("I_ConvocatoriasNacionales" == $this->chrt_array['tables'][0])
			return true;
		if("I_ConvocatoriasProvinciales" == $this->chrt_array['tables'][0])
			return true;
		if("I_ConvocatoriasProvinciales" == $this->chrt_array['tables'][0])
			return true;
		return false;
