...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "Mesa_Entrada_at_10_20_96_220";
		$data["connName"] = "Mesa_Entrada at 10.20.96.220";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;10.20.96.220;root;laclaveessecreta;;Mesa_Entrada;;1"; //currently unused

		$this->_connectionsIdByName["Mesa_Entrada at 10.20.96.220"] = "Mesa_Entrada_at_10_20_96_220";

		$data["connInfo"] = array();
		$data["ODBCUID"] = "root";
		$data["ODBCPWD"] = "laclaveessecreta";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
...
$host="10.20.96.220";
$user="root";
$pwd="laclaveessecreta";
$port="";
$sys_dbname="Mesa_Entrada";
...
;
		...
		$connectionsData["Mesa_Entrada_at_10_20_96_220"] = $data;
