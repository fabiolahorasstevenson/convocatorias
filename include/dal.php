...
class tDAL
{
	var $tblMesa_Entrada_at_10_20_96_220__I_ConvNacMailsNotif;
	var $tblMesa_Entrada_at_10_20_96_220__I_ConvocatoriasNacionales;
	var $tblMesa_Entrada_at_10_20_96_220__I_ConvocatoriasProvinciales;
	var $tblMesa_Entrada_at_10_20_96_220__UsuariosPermisos;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "I_ConvNacMailsNotif", "varname" => "Mesa_Entrada_at_10_20_96_220__I_ConvNacMailsNotif", "altvarname" => "I_ConvNacMailsNotif", "connId" => "Mesa_Entrada_at_10_20_96_220", "schema" => "", "connName" => "Mesa_Entrada at 10.20.96.220");
		$this->lstTables[] = array("name" => "I_ConvocatoriasNacionales", "varname" => "Mesa_Entrada_at_10_20_96_220__I_ConvocatoriasNacionales", "altvarname" => "I_ConvocatoriasNacionales", "connId" => "Mesa_Entrada_at_10_20_96_220", "schema" => "", "connName" => "Mesa_Entrada at 10.20.96.220");
		$this->lstTables[] = array("name" => "I_ConvocatoriasProvinciales", "varname" => "Mesa_Entrada_at_10_20_96_220__I_ConvocatoriasProvinciales", "altvarname" => "I_ConvocatoriasProvinciales", "connId" => "Mesa_Entrada_at_10_20_96_220", "schema" => "", "connName" => "Mesa_Entrada at 10.20.96.220");
		$this->lstTables[] = array("name" => "UsuariosPermisos", "varname" => "Mesa_Entrada_at_10_20_96_220__UsuariosPermisos", "altvarname" => "UsuariosPermisos", "connId" => "Mesa_Entrada_at_10_20_96_220", "schema" => "", "connName" => "Mesa_Entrada at 10.20.96.220");
	}
