 ...
 */
 ...
 class eventclass_I_ConvocatoriasNacionales  extends eventsBase
{
...
$values['RegistroFechaHora_iConvocatoriasNacionales'] = now();
return true;
;		
} // function BeforeAdd
...
function AfterAdd(&$values, &$keys, $inline, $pageObject)
{
		...
		// Mandar los emails: buscar los mails registrados  para notificar y que estén activos
// Código introducido por FHORAS - 09-05-18
// DNI 
...
// Residencia Completa
// Especialidad e Institución donde realizó la residencia 
// Especialidad Certificada e Institución Certificante
$fecha = date('d-m-Y');
$dni = $values['PersonaDNI_iConvocatoriasNacionales'];
$persona  = $values['PersonaApellidoNombre_iConvocatoriasNacionales'];
$fechanac = date("d-m-Y",strtotime($values['PersonaFechaNacimiento_iConvocatoriasNacionales']));
$provresi = $values['PersonaProvinciaReside_iConvocatoriasNacionales'];
$telefono = $values['PersonaTelefonoContacto_iConvocatoriasNacionales'];
$email    = $values['Personaemail_iConvocatoriasNacionales'];
$puestpos = $values['PuestoTrabajoPostula_iConvocatoriasNacionales'];
$titulo   = $values['TituloGrado_iConvocatoriasNacionales'];
$residcom = $values['ResidenciaCompleta_iConvocatoriasNacionales'];
$especial = $values['ResidenciaEspecialidad_iConvocatoriasNacionales'];
$instcert = $values['PersonaEspecialidadCertificada_iConvocatoriasNacionales'];
...
$TablaInicio= "
			<table border = 0 align = 'center' >
             ...
             <td width=200 height=40 scope='col' align = 'left'> <p>  <FONT size = 3 face= 'Times New Roman'>  $fechanac   </p></FONT></td>
					...
					<tr>
  						<th width=200 height=40 scope='col' align = 'left'> <FONT size = 3 face= 'Times New Roman'> <b> &nbsp Provincia reside </b></FONT></th>	
             ...
             <td width=200 height=40 scope='col' align = 'left'> <p>  <FONT size = 3 face= 'Times New Roman'>  $email </p></FONT></td>
					...
					<tr>
  						<th width=200 height=40 scope='col' align = 'left'> <FONT size = 3 face= 'Times New Roman'> <b> &nbsp Título de grado </b></FONT></th>
             ...
             <td width=200 height=40 scope='col' align = 'left'> <p>  <FONT size = 3 face= 'Times New Roman'>  $puestpos </p></FONT></td>
					...
					<tr>	
  						<th width=200 height=40 scope='col' align = 'left'> <FONT size = 3 face= 'Times New Roman'> <b> &nbsp Residencia completa </b></FONT></th>	
             <td width=200 height=40 scope='col' align = 'left'> <p>  <FONT size = 3 face= 'Times New Roman'>  $residcom </p></FONT></td>
					</tr>	
					<tr>	
  						<th width=200 height=40 scope='col' align = 'left'> <FONT size = 3 face= 'Times New Roman'> <b> &nbsp Especialidad </b></FONT></th>
             <td width=200 height=40 scope='col' align = 'left'> <p>  <FONT size = 3 face= 'Times New Roman'>  $especial </p></FONT></td>
					</tr>	
					<tr>	
  					<th width=200 height=40 scope='col' align = 'left'> <FONT size = 3 face= 'Times New Roman'> <b> &nbsp Institución certifica </b></FONT></th>	
           <td width=200 height=40 scope='col' align = 'left'> <p>  <FONT size = 3 face= 'Times New Roman'>  $instcert </p></FONT></td>
				</tr>	";
$FinTabla = "</table>";
$items= $items ."	
					  <tr>
...
$subject="Convocatorias MS: Aviso de inscripción postulante - Fecha: ".$fecha;
...
<table width="100%">
  ...
  <tr>
    <td><p>&nbsp;</p>
      <h5 align="left">Dirección de Informática Zona Sur - Ministerio de Salud <br> Alem Nro. 629 Piso 3 - Ushuaia (9410)</h5>
...
<table width="100%">
  ...
  <tr>
    <td><p>&nbsp;</p>
      <h5 align="left">Subsecretaría de Sistemas Informáticos y Comunicaicones - Ministerio de Salud <br> Alem Nro. 629 Piso 3 - Ushuaia (9410)</h5>
    <h6 align="center">Mensaje generado en forma automática por el Sistema de Convocatorias <br> Ministerio de Salud</h6></td>
  </tr>
</table>
</body>
