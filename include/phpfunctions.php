...
function CustomExpression($value, $data, $field, $ptype, $table="")
{
	...
	if(!$table)
		$table = $strTableName;
				if($table=="List_ConvocatoriasNacionales" && $field=="bPDF")
	{
		$id = $value;
$value= ' <a href = "ConvocatoriasNacionales_PrintPDF_print.php?id='.$value.'">
...
{
	$value = "";
				if($table=="I_ConvocatoriasNacionales" && $field=="PersonaCV_iConvocatoriasNacionales")
	{
		;
		return $value;
	}
				if($table=="List_ConvocatoriasNacionales" && $field=="PersonaCV_iConvocatoriasNacionales")
	{
		;
		return $value;
	}
				if($table=="ConvocatoriasNacionales_PrintPDF" && $field=="PersonaCV_iConvocatoriasNacionales")
	{
		;
		return $value;
	}
				if($table=="I_ConvocatoriasProvinciales" && $field=="PersonaCV_iConvocatoriasProvinciales")
	{
		;
		return $value;
	}
				if($table=="List_ConvocatoriasProvinciales" && $field=="PersonaCV_iConvocatoriasProvinciales")
	{
		;
		return $value;
	}
